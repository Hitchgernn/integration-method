...
\subsubsection{Perbandingan untuk $\int_0^{\pi/2} \cos(x) \, dx$ (Sejati: 1.0)}
\begin{table}[H]
\centering
...
Adaptif & 1.000000... & $\approx 1.26 \times 10^{-15}$ & (Estimasi error oleh kode) \\
...
\subsubsection{Perbandingan untuk $\int_0^1 x^2 \, dx$ (Sejati: 1/3)}
\begin{table}[H]
\centering
\begin{tabular}{l l l l}
\toprule
