...
\subsection{Implementasi Kode} 
Berikut adalah kode (dari \texttt{gaussNoLib.py}) implementasi Kuadratur Gauss menggunakan data $x_i$ dan $w_i$ dari tabel \ref{tab:parameter_gauss} sebagai parameter. 
...
\begin{figure}[H]
    ...
    % --- Kode Pertama ---
    \begin{lstlisting}[language=Python, caption={Fungsi gaussNoLib.py}, label=list:gauss1] 
import math
PI = math.pi
